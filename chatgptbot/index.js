...
function sendMessage() {
    ...
    // if message = developer - show our message
        ...
        setTimeout(() => {
            ...
            appendMessage('bot', 'This Source Coded By Devin Slifer \nYoutube : @CueGaming69');
    ...
    const options = {
        ...
        headers: {
            ...
            'X-RapidAPI-Key': 'e3374783aemsh3be56fb31a1d6bbp1c56ebjsnf0b01fd7e93c',
    ...
    fetch('open-ai21.p.rapidapi.com', options).then((response) => response.json()).then((response) => {
